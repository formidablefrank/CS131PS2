...
function y = P1(x)
    h = x/5
    y = h/3*p1(0) + 4*h/3*p1(x/5) + 2*h/3*p1(2*x/5) + 4*h/3*p1(3*x/5) + 2*h/3*p1(4*x/5) + h/3*p1(x)
endfunction
...
function y = P2(x)
    h = x/5
    y = h/3*p2(0) + 4*h/3*p2(x/5) + 2*h/3*p2(2*x/5) + 4*h/3*p2(3*x/5) + 2*h/3*p2(4*x/5) + h/3*p2(x)
endfunction
